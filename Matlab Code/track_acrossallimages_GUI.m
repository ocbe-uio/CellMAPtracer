...
gui_h.rectangle_size_slider = uicontrol('Parent', gui_h.rectanglesizepanel,...
  'Style', 'slider','Value', 70, 'Min', 50, 'Max', 90,... 
   'Units', 'Normalized','Position', [0 0 1 1]);

%% trackingpanel
gui_h.trackingpanel = uipanel('Parent',gui_h.figure1,...
  'Title', 'Control Tracking', 'FontWeight', 'bold',...
...
gui_h.use_centre_of_mass_checkbox = uicontrol('Parent', gui_h.trackingpanel,...
  ...
  'Units', 'Normalized', 'Position', [0.01 .75 .5 .15]);
...
gui_h.const_togglebutton = uicontrol('Parent', gui_h.trackingpanel,...
  'Style', 'togglebutton', 'String', 'Automated Tracking',...
...
gui_h.CellDivisionPanel = uipanel('Parent',gui_h.figure1,...
  'Title','Cell Division','FontWeight', 'bold', 'FontSize', 10,...
  'Units','Normalized', 'Position',[.8 .2 .15 .6]);
% 
gui_h.CurrentTrackCellColorIndicator = uicontrol('Parent',gui_h.CellDivisionPanel,...
  'Style','pushbutton','BackgroundColor', [.6 1 .6], ...
  'Units','Normalized', 'Position',[0.1 .9 .1 .05]);

gui_h.CurrentTrackCellColorIndicatorText = ...
  uicontrol('Parent',gui_h.CellDivisionPanel,...
  'Style','text','String', 'Current tracked cell', 'FontWeight','bold',...
  'Units','Normalized', 'Position',[0.2 .9 .8 .05]);

gui_h.Undo_CellDivision_pushbutton = uicontrol('Parent',...
  gui_h.CellDivisionPanel,'Style','pushbutton',...
  'String','Undo Cell Division',...
  'Units','Normalized','Position',[0.1 0 .8 .05]);

gui_h.CellDivision_pushbutton = uicontrol('Parent',gui_h.CellDivisionPanel,...
  'Style','pushbutton','String','Cell Division',...
  'Units','Normalized','Position',[0.1 0.05 .8 .1]);

%% save, close pushbuttons 
gui_h.SaveAndClose = uicontrol('Parent',gui_h.figure1,...
  'Style','pushbutton','String', 'Save & Close',...
  'Units','Normalized','Position', [.90 .95 .1 .05]);

gui_h.Cancel = uicontrol('Parent',gui_h.figure1,...
  'Style','pushbutton', 'String', 'Cancel',...
  'Units','Normalized','Position', [.9 .9 .1 .05]);
...
%% Change colors
gui_h = updatetrackingwindowcolors(gui_h);
