...
plot(dens,
  type = "l", col = "black", lwd = 0.1, xlim = c(0, 72), cex = 1.5, cex.lab = 1.3, cex.axis = 1.3,
...
legend(43, 0.047, c("Doubling Time Density", "Mode", "Median", "Mean"),
...
for (j in 1:length(DFF)) {
  ...
  par(mar = c(0, 0, 0, 0) + .1)
  plot(g,
    layout = co, edge.arrow.size = 1.5, vertex.shape = "circle", vertex.size = 26,
