...
All the needed data are available [here](https://github.com/ocbe-uio/CellMAPtracer/tree/master/Data/BT549%20tracking%20data).
...
```{r}
df1 <- read.csv(file.path(path, "A3_1_Feb12 All Cells.csv"))
df2 <- read.csv(file.path(path, "A3_2_Feb12 All Cells.csv"))
...
```{r}
df1 <- read.csv(file.path(path, "A3_1_Feb12 Daughter Cells.csv")
```
